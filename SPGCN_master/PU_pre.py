...
np.save('pretreatment_val/PaviaU_train_data.npy',train_data)
np.save('pretreatment_val/PaviaU_train_label.npy',train_label)
np.save('pretreatment_val/PaviaU_train_location.npy',train_location)

np.save('pretreatment_val/PaviaU_val_data.npy',val_data)
np.save('pretreatment_val/PaviaU_val_label.npy',val_label)
np.save('pretreatment_val/PaviaU_val_location('+iter+').npy',val_location)


np.save('pretreatment_val/PaviaU_test_data.npy',test_data)
np.save('pretreatment_val/PaviaU_test_label.npy',test_label)
np.save('pretreatment_val/PaviaU_test_location('+iter+').npy',test_location)

np.save('pretreatment_val/PaviaU_all_data.npy',all_data)
np.save('pretreatment_val/PaviaU_all_label.npy',all_label)
np.save('pretreatment_val/PaviaU_all_location.npy',all_location)

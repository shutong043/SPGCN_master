...
# val_numbers_I=np.int32(num_all-numbers_I)
...
np.save('pretreatment_val/IP_train_data.npy',train_data)
np.save('pretreatment_val/IP_train_label.npy',train_label)
np.save('pretreatment_val/IP_train_location.npy',train_location)

np.save('pretreatment_val/IP_val_data.npy',val_data)
np.save('pretreatment_val/IP_val_label.npy',val_label)
np.save('pretreatment_val/IP_val_location('+iter+').npy',val_location)


np.save('pretreatment_val/IP_test_data.npy',test_data)
np.save('pretreatment_val/IP_test_label.npy',test_label)
np.save('pretreatment_val/IP_test_location('+iter+').npy',test_location)

np.save('pretreatment_val/IP_all_data.npy',all_data)
np.save('pretreatment_val/IP_all_label.npy',all_label)
np.save('pretreatment_val/IP_all_location.npy',all_location)

...
numbers_I=[5,143,83,24, 49, 73, 3, 48, 2, 98, 246, 60, 21, 127, 39,10]
...
val_numbers_I=[int(numbers/2) for numbers in numbers_I]
val_numbers_I=numbers_I
...
np.save('pretreatment_val/Salinas_train_data.npy',train_data)
np.save('pretreatment_val/Salinas_train_label.npy',train_label)
np.save('pretreatment_val/Salinas_train_location.npy',train_location)

np.save('pretreatment_val/Salinas_val_data.npy',val_data)
np.save('pretreatment_val/Salinas_val_label.npy',val_label)
np.save('pretreatment_val/Salinas_val_location('+iter+').npy',val_location)


np.save('pretreatment_val/Salinas_test_data.npy',test_data)
np.save('pretreatment_val/Salinas_test_label.npy',test_label)
np.save('pretreatment_val/Salinas_test_location('+iter+').npy',test_location)

np.save('pretreatment_val/Salinas_all_data.npy',all_data)
np.save('pretreatment_val/Salinas_all_label.npy',all_label)
np.save('pretreatment_val/Salinas_all_location.npy',all_location)
